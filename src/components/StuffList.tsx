...
const furniture = [
  {
    id: 1,
    name: "Mutak Dolabı",
    image: "/products/beyaz-mutfak-dolabi.jpg",
    desc: "Beyaz mutak dolabı, el işçiliğiyle üretilmiş dayanıklı beyaz mutak dolabı.",
  },
  {
    id: 2,
    name: "Banyo Dolabı",
    image: "/products/banyo-dolabi.jpg",
    desc: "Banyo dolabı, el işçiliğiyle üretilmiş dayanıklı banyo dolabı.",
  },
  {
    id: 3,
    name: "Portmanto",
    image: "/products/portmanto.jpg",
    desc: "Portmanto, el işçiliğiyle üretilmiş dayanıklı portmanto.",
  },
  {
    id: 4,
    name: "Mutfak Dolabı",
    image: "/products/beyaz-mutfak-dolabi-2.jpg",
    desc: "Mutfak dolabı, el işçiliğiyle üretilmiş dayanıklı mutfak dolabı.",
  },
  {
    id: 5,
    name: "Genç Odası",
